    ...
    return (
        <div className="about-section">
            ...
            <div className="d-flex justify-content-between pb-3">
                <h1 className="text-light">My<span style={{ color: '#ffb400' }}> ALL Projects</span></h1>
            </div>
            <div className='row d-flex p-3 justify-content-center'>
                <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className="col-md-4 p-3 mr-5 mt-5 ml-5">
                    <div className="">
                    ...
                    <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className=" text-center">
                        ...
                        <div className="d-flex mt-4">
                            <a style={{ color: 'cyan' }} href="/">Github</a>
                            <a style={{ color: 'cyan' }} className="ml-4" href="/">Live Site</a>
                        </div>
                    </div>
                </div>

                <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className="col-md-4 mr-5 mt-5 p-3 ml-5">
                    <div>
                        <Slider {...settings} className="" >
                            <div className="wdt">
                ...
                <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className="col-md-4 mr-5 mt-5 p-3 ml-5">
                    ...
                    <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className=" text-center">
                        ...
                        <p className="text-light mt-2">A Tourist hotel booking website. Where we can booking a hotel for our upcoming tourist place. When we registered a hotel then it will suggestion place based on your selected place. Lastly, google map will assist you to make your travel experience smoother.
                </p>
                        <div className="mt-4 text-center">
                ...
                <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className="col-md-4 mr-5 mt-5 p-3 ml-5">
                    ...
                    <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className=" text-center">
                        <h5 class="text-uppercase  mt-2">
                            <span style={{ color: '#ffb400' }}>Social Buddy</span>
                        </h5>
                        <p className="text-light mt-2">A full-stack educational app Where users can see what online courses are offered to them. Where user can order any course and give feedback. Admin control whole system and add services. Admin Dashboard / User Dashboard.
                </p>
                        <div className="mt-4 text-center">
                ...
                <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className="col-md-4 mr-5 mt-5 p-3 ml-5">
                    ...
                    <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className=" text-center">
                        <h5 class="text-uppercase  mt-2">
                            <span style={{ color: '#ffb400' }}>Online Education School</span>
                        </h5>
                        <p className="text-light mt-2">A full-stack educational app Where users can see what online courses are offered to them. Where user can order any course and give feedback. Admin control whole system and add services. Admin Dashboard / User Dashboard.
                </p>
                        <div className="mt-4 text-center">
                ...
                <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className="col-md-4 mr-5 mt-5 p-3 ml-5">
                    ...
                    <div style={{ backgroundColor: 'rgb(23, 42, 69)' }} className=" text-center">
                        <h5 class="text-uppercase  mt-2">
                            <span style={{ color: '#ffb400' }}>Hard Rock Lyrics</span>
                        </h5>
                        <p className="text-light mt-2">A full-stack educational app Where users can see what online courses are offered to them. Where user can order any course and give feedback. Admin control whole system and add services. Admin Dashboard / User Dashboard.
                </p>
                        <div className="mt-4 text-center">
